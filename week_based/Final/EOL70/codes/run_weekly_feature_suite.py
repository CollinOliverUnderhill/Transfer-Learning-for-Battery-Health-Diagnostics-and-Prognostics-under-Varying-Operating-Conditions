...
DATA_CSV = ROOT / "features" / "feature_table_all_cells_multiweek_EOL70.csv"
GROUP_COND_CSV = REPO_ROOT / "metadata" / "Groupcondi.csv"
...
def run_one(week: int, cfg: Dict[str, object]) -> Path:
    ...
    split_csv = DOMAIN_SPLIT_DIR / f"cell_split_targetspread_w{week}_EOL70.csv"
...
def main() -> None:
    ...
    out_csv = RESULTS_DIR / "week_feature_transfer_comparison_repartitioned_EOL70.csv"
