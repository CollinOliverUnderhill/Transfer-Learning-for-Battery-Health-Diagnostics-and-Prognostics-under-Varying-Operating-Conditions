...
ROOT = Path(r"E:\Datasets\IVAS\Lifetime_RUL_prediction\EOL65")
SOURCE_CSV = Path(r"E:\Datasets\IVAS\Processing_Data_dd_exclude\EOL65\cell_split_by_lifetime_EOL65_augmented_weeks.csv")
WEEKS = (3, 5, 10, 15)
TARGET_COL = "lifetime_weeks_EOL65"
...
def main() -> None:
    ...
    write_rows(
        features_dir / "feature_table_all_cells_multiweek_EOL65.csv",
        rows,
        list(rows[0].keys()),
    )
    ...
    for week in WEEKS:
        ...
        split_csv = domain_dir / f"cell_split_targetspread_w{week}_EOL65.csv"
        group_csv = domain_dir / f"group_split_targetspread_w{week}_EOL65.csv"
        summary_csv = domain_dir / f"split_summary_targetspread_w{week}_EOL65.csv"
    ...
    write_rows(
        domain_dir / "weekly_split_manifest_EOL65.csv",
        manifest_rows,
